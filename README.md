...
|---|---|---|
| **Funding Rounds Explorer** | `/applets/funding-explorer` | Where is capital concentrated vs. thin? Filter 50+ real rounds by sector × GTM × tier × stage × city × investor. |
...
lib/
  data/
    ...
    funding-rounds.ts          50+ verified rounds (merges auto-rounds.json)
